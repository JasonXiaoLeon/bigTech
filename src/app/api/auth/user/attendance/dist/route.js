...
function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var url, start, end, Attendance, records, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!start || !end) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing startDate or endDate' }, { status: 400 })];
                    }
                    Attendance = mongoose_1["default"].connection.collection('attendance');
                    return [4 /*yield*/, Attendance.find({
                            date: {
                                $gte: start,
                                $lte: end
                            }
                ...
                case 2:
                    records = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(records)];
                case 3:
                    error_1 = _a.sent();
