...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, client, db, usersCollection, existingUser, hashedPassword, newUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!email || !password) {
                        return [2 /*return*/, server_1.NextResponse.json({ message: 'Missing email or password' }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    if (existingUser) {
                        return [2 /*return*/, server_1.NextResponse.json({ message: 'User already exists' }, { status: 409 })];
                    }
