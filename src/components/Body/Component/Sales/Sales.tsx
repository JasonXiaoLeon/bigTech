...
const Sales = () => {
  return (
    <div className='flex flex-col lg:flex-row-reverse md:items-center lg:justify-center py-[130px] relative' 
      style={{ backgroundImage: 'url(/img/sales.jpg)', 
               backgroundSize: 'cover', 
               backgroundPosition: 'center', 
               }}>
        <div className='px-[15px]'>
          <div className='flex flex-col bg-[#0b1d33] rounded-[20px] px-[30px] md:px-[45px] lg:px-[30px] py-[40px] md:py-[60px] lg:w-[450px] md:w-[570px] xl:w-[485px]'>
