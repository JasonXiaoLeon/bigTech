...
const Button: React.FC<Props> = ({
    ...
    return (
        <div className="relative group">
            <div
                className="flex justify-center px-[35px] py-[19px] border-2 rounded-[70px] border-[#00c4f4] text-[14px] text-white hover:text-[#00c4f4]"
                style={{ width, height }}
            >
                <button className="flex justify-center items-center uppercase text-[13px] font-outfit font-bold">
