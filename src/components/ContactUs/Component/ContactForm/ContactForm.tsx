                ...
                <div className="flex py-[35px] px-[20px] md:p-[60px] lg:p-[80px] w-[360px] md:w-[690px] lg:w-[930px] xl:w-[1220px]">
                    <form>
                        <div className="flex flex-col justify-between md:flex-row text-[16px] font-[400]">
                            <input
                                className="w-[320px] h-[65px] md:w-[270px] md:h-[65px] lg:w-[370px] xl:w-[515px] mb-[30px] rounded-[5px] px-[18px] py-[20px] bg-[#0b1d33] border border-[hsla(0,0%,100%,0.06)]"
                    ...
                    xl:w-[1060px] mb-[30px] rounded-[5px] px-[18px] py-[20px] bg-[#0b1d33] border border-[hsla(0,0%,100%,0.06)]"
                        />
