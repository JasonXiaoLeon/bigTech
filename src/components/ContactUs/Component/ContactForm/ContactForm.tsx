        ...
        <div className='flex py-[35px] px-[20px] md:p-[60px] lg:p-[80px] w-[360px] md:w-[690px] md:h-[495px] lg:w-[532px] lg:h-[572px] xl:w-[1060px]'>
            <form>
                <div className='flex flex-col justify-between md:flex-row'>
                    <input className='w-[320px] h-[65px] md:w-[270px] md:h-[65px] lg:w-[370px] xl:w-[515px] mb-[30px] rounded-[5px] px-[18px] py-[20px] bg-[#0b1d33] text-[18px] border border-gray-500' placeholder='Enter your Name'/>
                    <input className='w-[320px] h-[65px] md:w-[270px] md:h-[65px] lg:w-[370px] xl:w-[515px]  mb-[30px] rounded-[5px] px-[18px] py-[20px] bg-[#0b1d33] text-[18px] border border-gray-500' placeholder='Enter your Email'/>
                </div>
                <textarea
                    placeholder="Enter your message"
                    className='w-[320px] h-[184px] md:w-[570px] md:h-[184px] lg:w-[770px] 
                    xl:w-[1060px] mb-[30px] rounded-[5px] px-[18px] py-[20px] bg-[#0b1d33] text-[18px] border border-gray-500'
                />
