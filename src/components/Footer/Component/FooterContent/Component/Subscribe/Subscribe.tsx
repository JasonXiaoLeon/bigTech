    ...
    return (
        <div className="md:w-[360px] md:px-[15px] lg:px-[0px] lg:w-[320px] xl:w-[311.66px]">
            ...
            <div className="mb-[30px] xl:w-[311.66px]">
                <p className="h-[52px] text-[15px] text-[#a4b4c3] mb-[40px] md:mb-[60px] lg:w-[290px] xl:w-[311.66px] leading-[1.7335]">
                    {t('subscribe.description')}
                </p>
                <div className="flex w-[360px] md:w-[330px] lg:w-[320px] xl:w-[311.66px]">
                    <input
                        placeholder={t('subscribe.placeholder')}
                        className="w-[295px] md:w-[265px] lg:w-[225px] xl:w-[254.62px] h-[72px] text-white bg-[hsla(240,5%,49%,0.1)] rounded-[10px] py-[23px] px-[25px] text-[16px] p-[80px] focus:outline-none"
                    />
