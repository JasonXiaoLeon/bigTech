...
const Subscribe = () => {
  return (
    <div className='md:w-[360px] lg:w-[320px]'>
      <div className='uppercase mt-[25px] mb-[27px] text-white text-[18px] font-bold'>
      ...
      <div className='mb-[40px]'>
        ...
        <div className='flex w-[360px] md:w-[330px] lg:w-[320px]'>
          <input placeholder='info@gmail.com' className='w-[360px] md:w-[250px] lg:w-[216px] h-[72px] bg-[hsla(240,5%,49%,0.1)] rounded-[10px] py-[23px] px-[25px] p-[80px]'/>
