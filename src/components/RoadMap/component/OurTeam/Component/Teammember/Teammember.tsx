        ...
        <div className="flex justify-center px-[15px] w-screen md:w-[240px] lg:w-[320px] xl:w-[312.5px]">
            <div className="w-[360px] md:w-[210px] lg:w-[290px] xl:w-[282.5px] mb-[60px] text-white flex flex-col items-center group">
                <div className="relative flex justify-center items-center w-[227px] h-[227px] mb-[30px]">
                    <div className="absolute top-0 w-[227px] h-[227px] p-[15px] border-[2px] border-[#00c4f4] border-dashed rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-spin-fast transition-all duration-300"></div>
                    <img
                        src={imgUrl}
                ...
                <div className="flex flex-col items-center">
                    <h2 className="mb-[8px] text-center text-[19px]">{name}</h2>
                    <span className="mb-[10px] text-[16px] text-[#a4b4c3]">{jobTitle}</span>
