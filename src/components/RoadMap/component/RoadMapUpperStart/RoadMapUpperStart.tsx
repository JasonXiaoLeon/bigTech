...
const RoadMapUpperStart:React.FC<props> = ({ title, content1, blueContent }) => {
  return (
    <div className='flex md:justify-center'>
      <div className='flex justify-center w-[390px] md:w-[750px] lg:w-[400px] xl:w-[490px] px-[15px]'>
        <div className='w-[360px] md:w-[390px] lg:w-[370px] xl:w-[490px] mb-[35px]'>
          <div className='flex'>
              <DescripHeader content={title}/>
          </div>
          <div className='px-[15px] text-[28px] md:text-[40px] lg:text-[34px] xl:text-[42px] leading-[1.2] md:h-[96px] lg:h-[81.6px] xl:h-[100.8px] flex justify-center text-white font-bold'>
            <h2>
              {content1}
